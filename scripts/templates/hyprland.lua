...
hl.monitor({ output = "DP-2", mode = "2560x1440@100", position = "1920x0", scale = 1 })
...
local copy        = "cliphist list | rofi -dmenu -theme ~/.config/rofi/clipboard.rasi | cliphist decode | wl-copy"
...
hl.on("hyprland.start", function () 
  ...
  hl.exec_cmd("swww img ~/new_configs/scripts/active/wallpaper")
  hl.exec_cmd("hypridle")

  hl.exec_cmd("vscodium", { workspace = "workspace 1 silent" })
  hl.exec_cmd("alacritty", { workspace = "workspace 2 silent" })
  hl.exec_cmd("zen-browser", { workspace = "workspace 6 silent" })
  hl.exec_cmd("brave", { workspace = "workspace 7 silent" })
end)
...
hl.config({
    general = {
        ...
        col = {
            active_border   =  "rgb({{hypr_active_border}})",
            inactive_border =  "rgb({{hypr_background}})",
        },
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("sh ~/.config/hypr/scripts/selector.sh")) 
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("sh ~/.config/hypr/scripts/translate.sh")) 
...
hl.bind("ALT + SHIFT + 1",     hl.dsp.window.move({ workspace = 6 }))
hl.bind("ALT + SHIFT + 2",     hl.dsp.window.move({ workspace = 7 }))
hl.bind("ALT + SHIFT + 3",     hl.dsp.window.move({ workspace = 8 }))
hl.bind("ALT + SHIFT + 4",     hl.dsp.window.move({ workspace = 9 }))
hl.bind("ALT + SHIFT + 5",     hl.dsp.window.move({ workspace = 10 }))
