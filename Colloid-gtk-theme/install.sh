...
SCHEME_VARIANTS=('' '-Nord' '-Dracula' '-Gruvbox' '-Everforest' '-Catppuccin' '-Custom')
...
OPTIONS:
  ...
  --tweaks                Specify versions for tweaks
                          1. [nord|dracula|gruvbox|everforest|catppuccin|custom|all]  (Nord/Dracula/Gruvbox/Everforest/Catppuccin/Custom/all) ColorSchemes version
